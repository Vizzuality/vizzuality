...
ActiveRecord::Schema.define(version: 20161021055657) do
  ...
  create_table "blocks", force: :cascade do |t|
    ...
    t.index ["project_id"], name: "index_blocks_on_project_id", using: :btree
  end
  ...
  create_table "opinions", force: :cascade do |t|
    ...
    t.datetime "updated_at",                             null: false
    t.text     "description"
    t.index ["project_id"], name: "index_opinions_on_project_id", using: :btree
  end
